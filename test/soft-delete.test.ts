...
import { pgTable, text as pgText, uuid, timestamp as pgTimestamp } from 'drizzle-orm/pg-core';
import { mysqlTable, varchar, timestamp as mysqlTimestamp } from 'drizzle-orm/mysql-core';
...
import { softDeleteColumns as sqliteColumns, softDeleteTimestamp as sqliteTimestamp } from '../src/soft-delete/sqlite.js';
import { softDeleteColumns as pgColumns, softDeleteTimestamp as pgTimestampOnly } from '../src/soft-delete/pg.js';
import { softDeleteColumns as mysqlColumns, softDeleteTimestamp as mysqlTimestampOnly } from '../src/soft-delete/mysql.js';
